      ...
      (extract-labels
       ...
       (lambda (insts labels)
         ...
         (let ((next-inst (car text)))
           ...
           ;(display "Next insts: " )(display next-inst)
           ;(display "labels: " )(display labels)
           ;(newline);;   accumulated (as on a stack):
...
(define (instruction-execution-proc inst)
  ;(newline)(display "Instruction: ")(display inst)(newline)
  (cdr inst))
        ...
        (aprocs
         (map (lambda (e)
                (if (not (or (register-exp? e) (constant-exp? e)))
                    (error "operations can only be used with registers and constants" e)
